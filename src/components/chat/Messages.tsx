...
import { ExtendedMessages } from "@/src/types/message";
...
const Messages = ({ fileId }: MessageProps) => {
  ...
  const loadingMessage: ExtendedMessages={
  ...
  const combinedMessages: ExtendedMessages[] = [
    ...(isAiThinking ? [loadingMessage]:[]),
    ...((messages ?? [] )as ExtendedMessages[])
  ]
  ...
  return (
    <div className="flex max-h-[calc(100vh-3.5rem-7rem)] border-zinc-200 flex-1 
    flex-col-reverse gap-4 p-3 overflow-y-auto 
